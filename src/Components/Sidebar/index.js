  ...
  return (
    <div className="sidebar">
      <div className="profile-div">
        ...
        <label className="usr-lbl">{auth.admin.fullName}</label>
        <label className="role-lbl">{auth.admin.role}</label>
      </div>
      {/*  */}
      ...
      <div className="btn-group">
        <div className="btn-group-header">
          <div className="btn" onClick={expand1}>
            ...
            <span className="icon2">
              {toggle1 ? <FiChevronUp /> : <FiChevronDown />}
            </span>
          </div>
        </div>
        {toggle1 ? (
          <div className="btn-group-body1">
            <div className="btn-1 btn-2">
              <NavLink to={"/product/fetch"} className="title1">
                <span
                  style={{ marginRight: "10px", color: "white" }}
                  className="icon1"
                >
            ...
            <div className="btn-1 btn-2">
              <NavLink to={"/product/create"} className="title1">
                <span
                  style={{ marginRight: "10px", color: "white" }}
                  className="icon1"
                >
      ...
      <div className="btn-group">
        <div className="btn-group-header">
          <div className="btn" onClick={expand2}>
            ...
            <span className="icon2">
              {toggle2 ? <FiChevronUp /> : <FiChevronDown />}
            </span>
          </div>
        </div>
        {toggle2 ? (
      ...
      <div className="btn-group">
        <div className="btn-group-header">
          <div className="btn" onClick={expand3}>
            ...
            <span className="icon2">
              {toggle3 ? <FiChevronUp /> : <FiChevronDown />}
            </span>
          </div>
        </div>
        {toggle3 ? (
      ...
      <div className="btn-group">
        <div className="btn-group-header">
          <div className="btn" onClick={expand4}>
            ...
            <span className="icon2">
              {toggle4 ? <FiChevronUp /> : <FiChevronDown />}
            </span>
          </div>
        </div>
        {toggle4 ? (
          <div className="btn-group-body1">
            <div className="btn-1 btn-2">
              <NavLink to={"/category/fetch"} className="title1">
                <span
                  style={{ marginRight: "10px", color: "white" }}
                  className="icon1"
                >
            ...
            <div className="btn-1 btn-2">
              <NavLink to={"/category/create"} className="title1">
                <span
                  style={{ marginRight: "10px", color: "white" }}
                  className="icon1"
                >
