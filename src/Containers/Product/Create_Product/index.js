...
const Create_Product = (props) => {
  ...
  const CreateProduct_Btn_Clicked = () => {
    ...
    //   amt_original_price: amt_o_price,
    //   amt_selling_price: amt_s_price,
    //   qty_original_price: qty_o_price,
    //   qty_selling_price: qty_s_price,
    ...
    newProduct.append("amt_original_price", amt_o_price);
    newProduct.append("amt_selling_price", amt_s_price);
    newProduct.append("qty_original_price", qty_o_price);
    newProduct.append("qty_selling_price", qty_s_price);
    newProduct.append("stock_amount", stock_amt);
    newProduct.append("stock_quantity", stock_qty);
    newProduct.append("category", Category);
    newProduct.append("unit", unit);
    newProduct.append("qtyunit", qtyunit);
    newProduct.append("base_quantity", base_quantity);

    for (let pic of files) {
      console.log(pic);
      newProduct.append("productPicture", pic);
    }

    // ******* FormData can't be logged directly.
    // for (var key of newProduct.entries()) {
    //   console.log(key[0] + ", " + key[1]);
    // }

    dispatch(create_product_action(newProduct));
  };
        ...
        <div className="cr-0-cate">
          <div className="brd-cumb-div">
            <Breadcrumb>
              ...
              <Breadcrumb.Item
                href="http://localhost:9000/product/fetch"
                className="brd-cumb"
              >
                allproduct
              </Breadcrumb.Item>
              <Breadcrumb.Item className="brd-cumb" active>
                addproduct
              </Breadcrumb.Item>
            </Breadcrumb>
          </div>
          ...
          <div className="cr-2-div">
            ...
            <section className="container">
              <div {...getRootProps({ className: "dropzone" })}>
                ...
                <label className="upload-lbl">Upload Pictures</label>
              </div>
          ...
          <div className="cr-3-4-main-div">
            ...
            <div className="cr-3-div">
              ...
              <div className="cr-3-2-div">
                ...
                />
                {unit === "" ? (
                  <label className="unit-2nd-lbl">/ Unit</label>
                ) : (
                  <label className="unit-2nd-lbl">/ {unit}</label>
                )}
                <TextField
            ...
            <div className="cr-4-div">
              ...
              <div className="cr-3-2-div">
                ...
                {qtyunit === "" ? (
                  ...
                  <label className="unit-2nd-lbl">/ {qtyunit}</label>
                )}
                <TextField
                  label="Selling_Price"
                  variant="outlined"
          ...
          <div className="cr-pr-btn-div">
            <Button
              variant="outlined"
              onClick={CreateProduct_Btn_Clicked}
              className="cr-pr-btn"
              color="primary"
            >
              Create Product
